...
export function SignInCard({ 
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-sky-900 via-blue-900 to-slate-900 relative overflow-hidden flex items-center justify-center">
      {/* Background gradient effect - matches TravelGenie theme */}
      <div className="absolute inset-0 bg-gradient-to-b from-sky-500/20 via-blue-700/30 to-slate-900" />
      ...
      {/* Top radial glow */}
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[120vh] h-[60vh] rounded-b-[50%] bg-sky-400/20 blur-[80px]" />
      <motion.div 
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[100vh] h-[60vh] rounded-b-full bg-sky-300/20 blur-[60px]"
        animate={{ 
          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  Sign in to continue to TravelGenie
                </motion.p>
              </div>
