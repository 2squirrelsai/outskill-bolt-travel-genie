  ...
  ({ className, title = "TravelGenie", description = "Plan amazing trips with AI-powered recommendations and smart itinerary management.", showSocials = true, ...props }, ref) => {
    return (
      <div
        ...
        {...props}
      >
        <div className="relative h-full rounded-[50px] bg-gradient-to-br from-sky-900 to-blue-900 shadow-2xl transition-all duration-500 ease-in-out [transform-style:preserve-3d] group-hover:[box-shadow:rgba(0,0,0,0.3)_30px_50px_25px_-40px,rgba(0,0,0,0.1)_0px_25px_30px_0px] group-hover:[transform:rotate3d(1,1,0,30deg)]">
