...
export const EditActivityModal: React.FC<EditActivityModalProps> = ({ activity, onSave, onClose }) => {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                  errors.duration ? 'border-red-300' : 'border-gray-300 dark:border-gray-600'
                }`}
                min="15"
                step="15"
              />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                errors.cost ? 'border-red-300' : 'border-gray-300 dark:border-gray-600'
              }`}
              min="0"
              step="1"
              placeholder="0"
